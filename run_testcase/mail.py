...
def send_email(newfile):
    ...
    password = 'AUQQGOUSXGOJCLYQ'#RIUJKPOIAZJKJEEQ
    # 发送邮箱
    sender = '17600570787@163.com'
    # 多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver = ['1430242070@qq.com']#'zhaozhansheng_v@didiglobal.com',
    # 发送邮件主题
...
if __name__ == '__main__':
    ...
    runner = HTMLTestRunner(stream=fp, title=u'自动化测试报告', description=u'自动化测试报告')
    runner.run(suite)
